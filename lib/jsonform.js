  ...
  'crossdate': {
    'template':
        '<div class="input-group date" id="datetimepicker1">'+
                    '<input name="<%= node.name %>" type="text" class="form-control" id="<%= id %>" value="<%= escape(value) %>" <%= (node.disabled? " disabled" : "")%> <%= (node.readOnly ? " readonly=\'readonly\'" : "") %> <%= (node.schemaElement && node.schemaElement.required && (node.schemaElement.type !== "boolean") ? " required=\'required\'" : "") %> />'+
